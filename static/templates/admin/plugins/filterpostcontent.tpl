<form role="form" class="filterpostcontent-settings">
	<div class="row mb-4">
		<div class="col-sm-2 col-12 settings-header">General</div>
		<div class="col-sm-10 col-12">
			<p class="lead">
				Adjust these settings. You can then retrieve these settings in code via:
				<code>meta.settings.get('filterpostcontent', function(err, settings) {...});</code>
			</p>
			<div class="mb-3">
	...
	<div class="row mb-4">
		...
		<div class="col-sm-10 col-12">
			<div class="mb-3" data-type="sorted-list" data-sorted-list="sample-list" data-item-template="admin/plugins/filterpostcontent/partials/sorted-list/item" data-form-template="admin/plugins/filterpostcontent/partials/sorted-list/form">
