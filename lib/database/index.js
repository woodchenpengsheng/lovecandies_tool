const { RechargeOrderStatus, rechargePrefixName } = require("./define");
...
DataBase.getNextServiceId = async function() {
    return await db.incrObjectField('global', `${rechargePrefixName}:nextServiceId`);
}
